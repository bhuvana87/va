...
(function() {
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.setupAnnotation = function(annotation) {
      ...
      annotation.swidth = '';
      annotation.sheight = '';
      annotation.annuserid = userId;
      annotation.annvideo = videoSrc;
    ...
    Permissions.prototype.pluginInit = function() {
      ...
      if (this.options.showViewPermissionsCheckbox === true) {
        this.annotator.editor.addField({
          ...
          load: createCallback('updatePermissionsField', 'write'),
          submit: createCallback('updateAnnotationPermissions', 'write')
        });
      }
